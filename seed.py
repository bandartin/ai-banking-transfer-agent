...
def run(app=None):
    ...
    with app.app_context():
        ...
        casual_pool = [
            (f_seoyeon,  [12_000, 23_500, 35_000, 48_000, 89_000]),
            (f_jiyeon,   [15_000, 27_000, 33_000, 52_000]),
            (f_roommate, [18_000, 22_000, 41_000, 65_000]),
            (f_minsoo1,  [14_000, 30_000, 45_000]),
            (f_minsoo2,  [20_000, 36_000]),
            (f_brother,  [50_000, 100_000, 150_000]),
            (f_sister,   [40_000, 70_000]),
            (f_donggi,   [25_000, 100_000]),
            (f_dad,      [100_000, 300_000]),
            (f_grandma,  [100_000, 200_000]),
            (f_aunt,     [50_000]),
            (f_cousin,   [60_000]),
        ]
